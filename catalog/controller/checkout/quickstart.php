...
$spreadsheetId = '1h0Z-Zu1oEWLhyXLWQNE3VF9xifGao18g2BkXJEAv0rU';


$spreadsheet = (new Google\Spreadsheet\SpreadsheetService)
    ->getSpreadsheetFeed()
    ->getByTitle('лиды nike air 95');

$worksheetFeed = $spreadsheet->getWorksheetFeed()->getByTitle('table');
$listFeed = $worksheetFeed->getListFeed();
