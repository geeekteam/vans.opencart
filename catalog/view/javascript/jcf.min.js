!function (e, t) {
    ...
    !function () {
        ...
        var t = ("onwheel" in document || document.documentMode >= 9 ? "wheel" : "mousewheel DOMMouseScroll").split(" "), n = "jcf-mousewheel";
        e.event.special[n] = {
            setup: function () {
                var n = this;
        ...
        version: t, modules: {}, getOptions: function () {
            ...
            return o.styleSheetCreated || r(), e(t).each(function () {
                ...
                i = r.data(o.dataKey), i ? i.refresh() : (n || e.each(s.modules, function (e, t) {
                    if (t.prototype.matchElement.call(t.prototype, r))return n = e, !1
